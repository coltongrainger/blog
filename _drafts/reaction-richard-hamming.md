---
title: Reaction to Richard Hamming
layout: post
...
At the moment, I am concerned with working on invariable problems---carelessly spending energy on fixed points, without fluidity in my work.
...
Can I force problems to be characteristic of a class? 

> You should do your job in such a fashion that others can build on top of it, so they will indeed say, ``Yes, I've stood on so and so's shoulders and I saw further.'' The essence of science is cumulative. By changing a problem slightly you can often do great work rather than merely good work. Instead of attacking isolated problems, I made the resolution that I would never again solve an isolated problem except as characteristic of a class.

Reminds me of Bacon.

And here, wrt sharing information, or developing general methods
...
I'm not sure that I'm ready to brad needlessly.
...
In what ways can I become more courageous? Potentially at the shelter; spending time with residents. Alternatively, I could shore up and have some honesty with myself. I need to build the courage to leave bad scenes and get my own work done. I need the courage to admit ignorance. Also the courage to work so fast that I risk abjection & failure.
...
Wrt reading, I have failed to heed advice to *read aggressively*. At the moment, I am a painfully slow reader and I queue up books to read. I've got to burn through them. How can I trick myself into leisurely perusal? Well, by conjuring great scholastic images. I'm courting already arrangements of words, lizards poetically slouching over my desk. Maybe these images are inherited from drug use.
...
Also hilarious, I hadn't known where this reference was from:
...
Here's a pitch for simplifying, maybe where I have a competitive advantage (and also a caution about "deploying too early, to use a parachute metaphor).
